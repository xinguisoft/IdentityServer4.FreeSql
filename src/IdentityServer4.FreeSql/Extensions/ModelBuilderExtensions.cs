...
namespace IdentityServer4.FreeSql.Extensions
{
    ...
    {
        private static EfCoreTableFluent<TEntity> ToTable<TEntity>(this EfCoreTableFluent<TEntity> entityTypeBuilder, TableConfiguration configuration)
            where TEntity : class
        {
        ...
        public static void ConfigureClientContext(this ICodeFirst modelBuilder, ConfigurationStoreOptions storeOptions)
        {
        ...
        /// <param name="modelBuilder">The model builder.</param>
        /// <param name="storeOptions">The store options.</param>
        public static void ConfigurePersistedGrantContext(this ICodeFirst modelBuilder, OperationalStoreOptions storeOptions)
        {
            // if (!string.IsNullOrWhiteSpace(storeOptions.DefaultSchema)) modelBuilder.HasDefaultSchema(storeOptions.DefaultSchema);
            ...
            modelBuilder.Entity<PersistedGrant>(grant =>
            {
                ...
                grant.Property(x => x.Key).HasMaxLength(200).Help().IsIdentity(true); //.ValueGeneratedNever();
        ...
        /// <param name="modelBuilder">The model builder.</param>
        /// <param name="storeOptions">The store options.</param>
        public static void ConfigureResourcesContext(this ICodeFirst modelBuilder, ConfigurationStoreOptions storeOptions)
        {
            //if (!string.IsNullOrWhiteSpace(storeOptions.DefaultSchema)) modelBuilder.HasDefaultSchema(storeOptions.DefaultSchema);
            ...
            modelBuilder.Entity<ApiResourceScope>(apiResourceScope =>
            {
                apiResourceScope.ToTable((TableConfiguration)storeOptions.ApiResourceScope).HasKey(x => x.Id);

                apiResourceScope.Property(x => x.Scope).HasMaxLength(200).IsRequired();
            });
