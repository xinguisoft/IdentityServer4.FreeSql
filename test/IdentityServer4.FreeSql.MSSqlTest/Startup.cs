...
namespace IdentityServer4.FreeSql.MSSqlTest
{
    public class Startup
    {
        ...
        {
            var connectionString = "Data Source=127.0.0.1;Initial Catalog=Auth_IDS;User ID=sa;Password=123456;MultipleActiveResultSets=true;";
